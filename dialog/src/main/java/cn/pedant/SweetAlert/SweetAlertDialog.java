...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private boolean mShowCanfirm = true;
    ...
    private FrameLayout mEditingFrame;
    private FrameLayout mSexFrame;
    private LinearLayout mPasswordLayout;
    private FrameLayout mSignFrame;
    ...
    public static final int SEX_TYPE = 7;
    public static final int PASSWORD_TYPE = 8;
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case PROGRESS_TYPE:
                    ...
                    break;
                case EDIT_TYPE:
                    mEditingFrame.setVisibility(View.VISIBLE);
                    break;
                case SEX_TYPE:
                    mSexFrame.setVisibility(View.VISIBLE);
                    addSexChooseListener();
                    break;
                case PASSWORD_TYPE:
                    mPasswordLayout.setVisibility(View.VISIBLE);
                    break;
                case SIGN_TYPE:
                    mSignFrame.setVisibility(View.VISIBLE);
                    break;
            }
            if (!fromCreate) {
                playAnimation();
    ...
    private void addSexChooseListener() {
        mSexGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (checkedId == R.id.rbMan) {
                    ...
                    currentChooseSex = 1;
                } else if (checkedId == R.id.rbSexSecret) {
                    currentChooseSex = 2;
                }
            }
        });
    ...
    public SweetAlertDialog setSex(int index) {
        currentChooseSex = index;
        if (mSexGroup != null && (currentChooseSex >=0 || currentChooseSex <= 2)) {
            mSexGroup.check(currentChooseSex == 0 ? R.id.rbMan : currentChooseSex == 1 ? R.id.rbWoman : R.id.rbSexSecret);
        }
        return this;
    }
    ...
    public SweetAlertDialog showConfirmButton (boolean isShow) {
        ...
        if (mConfirmButton != null) {
            mConfirmButton.setVisibility(mShowCanfirm ? View.VISIBLE : View.GONE);
        }
        return this;
    }
    ...
    public int getSex() {
        return currentChooseSex;
    }

    public String[] getPassword() {
        return new String[]{mOldPassword.getText().toString().trim(), mNewPassword.getText().toString().trim()};
    }

    public String getSign() {
        return mEditSign.getText().toString().trim();
    }
